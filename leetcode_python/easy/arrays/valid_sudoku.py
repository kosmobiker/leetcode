...
if __name__ == '__main__':
    ...
    assert r1 == expected_output1, f"Test Case 1 Failed: expected output {expected_output1}, but got {r1}"
    ...
    assert r2 == expected_output2, f"Test Case 2 Failed: expected output {expected_output2}, but got {r2}"