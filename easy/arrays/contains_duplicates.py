...
if __name__ == '__main__':
    ...
    assert result2 == expected2, f"Test Case 1 Failed: expected output {expected2}, but got {result2}"

    nums3 = [1,1,1,3,3,4,3,2,4,2]
    expected3 = True
    result3 = s.containsDuplicate(nums3)
    assert result3 == expected3, f"Test Case 1 Failed: expected output {expected3}, but got {result3}"