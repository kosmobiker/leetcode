...
if __name__ == '__main__':
    ...
    for i in range(k):
        assert nums1[i] == expected_nums1[i], f"Test Case 1 Failed: expected {expected_nums1[i]}, but got {nums1[i]}"
    ...
    assert nums2 == expected_nums2, f"Test Case 2 Failed: expected {expected_nums2}, but got {nums2}"
    ...
    for i in range(k):
        assert nums3[i] == expected_nums3[i], f"Test Case 3 Failed: expected {expected_nums3[i]}, but got {nums3[i]}"
    ...
    for i in range(k):
        assert nums4[i] == expected_nums4[i], f"Test Case 4 Failed: expected {expected_nums4[i]}, but got {nums4[i]}"